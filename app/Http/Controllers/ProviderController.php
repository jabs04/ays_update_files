...
class ProviderController extends Controller
{
    ...
    public function index_data(DataTables $datatable,Request $request)
    {
     ...
     public function index_data_depo(DataTables $datatable,Request $request)
    {
        $query = User::query();
        $filter = $request->filter;
        ...
        $getReq = auth()->user()->area;
        $getAllArea = explode(',',$getReq);
   
        foreach($getAllArea as $area){
          $gett = $query->where('city_id', $area);
          if($gett != null){
            $query = $query->orWhere('city_id', $area);;
          }
        }
        // array_push($query, [
        //     "id" => 9,
        ...
        //     "referal_code"=> null,
        //     "upline"=> "AYS-B2GIYR",
        //     "username"=> "nntdemo@appyourserbisyo.ph",
        //     "first_name"=> "Demo",
        //     "last_name"=> "for NNT",
        //     "email"=> "nntdemo@appyourserbisyo.ph",
        //     "user_type"=> "provider",
        //     "contact_number"=> "09165307250",
        //     "country_id"=> 173,
        //     "state_id"=> 2852,
        //     "city_id"=> 0,
        //     "area"=> null,
        //     "provider_id"=> null,
        //     "address"=> null,
        //     "player_id"=> "88bf67d3-7403-4793-9dec-4990bc01ad71",
        //     "status"=> 1,
        //     "display_name"=> "Demo for NNT",
        //     "providertype_id"=> 1,
        //     "is_featured"=> 0,
        //     "time_zone"=> "UTC",
        //     "last_notification_seen"=> "2024-04-11 08:49:20",
        //     "email_verified_at"=> null,
        //     "deleted_at"=> null,
        //     "created_at"=> "2023-06-06T09:41:25.000000Z",
        //     "updated_at"=> "2024-04-11T08:49:20.000000Z",
        //     "login_type"=> null,
    ...
    public function create(Request $request)
    {
        ...
        return view('provider.create', compact('pageTitle' ,'providerdata' ,'auth_user', 'country_id', 'country_name' ));
    }
    ...
    public function show($id)
    {
        ...
        if($providerdata == null){
           $providerdata = DB::table('users')->where('user_type', 'provider')->where('id', $id)->first(); 
        }
        //  dd($providerdata);
        $usid = $id;
        ...
        $providerData = [
            'providerTotEarning' => isset($providerTotEarning->provider_booking_sum_total_amount) ? $providerTotEarning->provider_booking_sum_total_amount : "",
            'providerTotWithdrableAmt' => isset($providerTotEarning->provider_booking_sum_total_amount) ? $providerTotEarning->provider_booking_sum_total_amount : "",
